...
public class PhotoActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        text = view.findViewById(R.id.profile_nickname);
        ...
        mDatabase.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    text.setText(dataSnapshot.child(user.getUid()).getValue().toString());
                }
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            imageBitmap = Bitmap.createScaledBitmap(imageBitmap,540,960,false);
            ...
            UploadTask uploadTask = storageRef.child(user.getUid()).putBytes(data2);
